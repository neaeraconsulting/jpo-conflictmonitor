...
/**
 * Covers AtspmSpatPairEvent#fromLog(AtspmSpatPairLog, SignalGroupStatistics), the factory
 * that scopes an event's pairs and percentages to a single signal group.
 */
class AtspmSpatPairEventTest {
    ...
    void fromLogCopiesRouteSignalAndTimeFieldsFromTheLog() {
        ...
        AtspmSpatPairEvent event = AtspmSpatPairEvent.fromLog(log, stats);
