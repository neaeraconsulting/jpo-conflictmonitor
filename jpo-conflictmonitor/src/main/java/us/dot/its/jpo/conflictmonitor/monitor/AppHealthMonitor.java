...
public class AppHealthMonitor {
     ...
     * Use this if /actuator/prometheus returns 500: curl localhost:8082/health/prometheus
     */
    ...
    /**
     * Debug scrape formats. Use when /actuator/prometheus returns 500.
     */
     ...
     * Use this to identify which topologies still dominate CPU after optimizations.
     *
