...
public class SpatMessageCountProgressionTopology
        extends BaseStreamsBuilder<SpatMessageCountProgressionParameters>
    ...
    public void buildTopology(StreamsBuilder builder, KStream<RsuIntersectionKey, ProcessedSpat> inputStream) {
        if (parameters.isAggregateEvents() && aggregationAlgorithm == null) {
        ...
        builder.addStateStore(
                Stores.versionedKeyValueStoreBuilder(
                        ...
                        JsonSerdes.SpatMessageCountState()
                )
        );
        ...
        if (parameters.isAggregateEvents()) {
            ...
            .repartition(
                    Repartitioned.with(
                            JsonSerdes.SpatMessageCountProgressionAggregationKey(),
                            JsonSerdes.SpatMessageCountProgressionEvent())
