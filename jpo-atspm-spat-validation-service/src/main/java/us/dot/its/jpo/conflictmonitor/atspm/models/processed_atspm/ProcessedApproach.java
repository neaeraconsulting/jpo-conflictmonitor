...
public class ProcessedApproach {
    ...
    public static ProcessedApproach fromApproach(
        ...
        pa.setApproachID(approach.getApproachID());
        ...
        pa.setDescription(approach.getDescription());
        pa.setProtectedPhaseNumber(approach.getProtectedPhaseNumber());
        pa.setPermissivePhaseNumber(approach.getPermissivePhaseNumber());
        pa.setPedestrianPhaseNumber(approach.getPedestrianPhaseNumber());
